...
<div class="container col-md-10"><br>
    <table class="table table-striped">
        ...
        foreach ($h->result() as $row)
        {
            ...
            <td><button type="button" class="btn btn-info" onclick="view_pending_orders(<?php echo $row->order_number; ?>)">View</button></td>
            </tr>
        <?php }
        ?>
        </tbody>
...
<div class="container modal fade" style="padding-top: 20px" id="viewPendingOrdersModal">
...
<script type="text/javascript">
    var save_method;
    function view_pending_orders(order_number){
        save_method = 'view';
        $.ajax({
            url: "<?php echo site_url(); ?>/Admin/view_each_pending_order/" + order_number,
            type: "GET",
            dataType: "JSON",
